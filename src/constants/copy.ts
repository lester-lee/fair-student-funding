export const NARRATIVE = [
  ...
  },
  {
    ...
    body:`Let's take a closer look at the funds allocated to district schools. The Principal of each school is responsible for working with their School Leadership Team to create a plan for how that money should be spent.`
  },
  {
  ...
  },
  {
    ...
    body:`While the goal is to be transparent, the money from FSF is only a small percentage of total school budget. How is the money calculated and spend in other areas? Are the weights for FSF fair? (elaborate, idk)`
  },
];